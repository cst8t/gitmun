...
function diffToolLabel(tool: ExternalDiffTool): string {
  switch (tool) {
    case "Other": return "None / Other";
    case "VsCode": return "VS Code";
    case "VsCodium": return "VS Codium";
    default: return tool;
  }
}
    ...
    <div className="settings-window">
      ...
      <div className="settings-window__body">
        ...
        <div className="settings-window__column">
          ...
          <div className="settings-window__row">
            ...
            <div className="settings-window__sub-section">
              <button className="settings-window__btn settings-window__btn--secondary" onClick={handleOpenResultLog}>
          ...
          <div className="settings-window__row">
            ...
            <div className="settings-window__inline-controls">
              <button className="settings-window__btn settings-window__btn--secondary" onClick={handleResetLayout}>
                Reset panel layout
              </button>
            </div>
          </div>
          ...
          <div className="settings-window__row">
            ...
            <div className="settings-window__inline-controls" style={{ gap: "6px", flexWrap: "nowrap" }}>
              ...
              />
              <button className="settings-window__btn settings-window__btn--secondary settings-window__icon-btn" onClick={handleBrowseCloneDir}>
                <FolderIcon />
              </button>
            </div>
          </div>
              ...
              <div className="settings-window__row">
                ...
                {externalDiffTool === "Other" && (
                  <div className="settings-window__warning">
                    No known difftool is configured. Compare actions may not work unless you have configured one manually in your git config.
                ...
                {(externalDiffTool === "VsCode" || externalDiffTool === "VsCodium") && (
                  <div className="settings-window__note">
                    {diffToolLabel(externalDiffTool)}'s merge editor writes the result file when closed, so conflicts will be marked as resolved even if you close without explicitly accepting a side. Use the Accept buttons inside the editor to choose which version to keep.
                  </div>
                )}
              </div>

              <div className="settings-window__row">
                <label className="settings-window__label">Default branch name (`init.defaultBranch`)</label>
                <input
                  className="settings-window__input"
                  type="text"
      ...
      <div className="settings-window__footer">
        <div className="settings-window__actions">
          <button className="settings-window__btn settings-window__btn--primary" onClick={handleSave} disabled={saving}>
            {saving ? "Saving..." : "Save"}
          </button>
